<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Layout.Master" AutoEventWireup="true" CodeBehind="FondiDetail.aspx.cs" Inherits="Article75.FondiDetail" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="meta">
                                ...
                                <div class="signature-info pull-left">Fondi: <span>SI : 8396</span> vs <span> NO : 5245</span></div>
                                ...
                                <ul class="list-unstyled social-area social-area-signature pull-right">
                                    ...
                                    <li><a href="http://twitter.com/share?http://185.117.152.92:8081/ReferendaDetail.aspx&text=Fondi&via=Article75" class="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>

                                    <li><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://185.117.152.92:8081/FondiDetail.aspx&title=Fondi&summary=FondiDetail&source=Article75" class="linkedin"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="meta-info">
                            ...
                            <div class="social text-right">
                                <asp:Button ID="BtnNo111" runat="server" onclick="BtnNo111_Click" class="btn btn-brand" Text="NO" CausesValidation="False" UseSubmitBehavior="False"/>	
                                <asp:Button ID="BtnYes1" runat="server" onclick="BtnYes1_Click" class="btn btn-brand" Text="SI" CausesValidation="False"/>	
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 text-center">
                            ...
                            <h3 class="section-heading heading-no-top-margin">Sign this Fondi</h3>
